    ...
    <>
      ...
      <main className="dark:text-light flex items-center text-dark w-full min-h-screen">
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              ...
              50vw"
               src={profilePic} alt="Anirban" className="w-full h-auto lg:hidden md:inline-block md:w-full" />
            </div>
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              
            <AnimatedText text="Unleashing Innovation with Code, Design, and Passion." className="!text-6xl !text-left
            xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl"/>

              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
              Innovative Full Stack Web Dev | JAVA aficionado | AWS, GCP, DevOps | Tech Saavy | Networking Enthusiast | Let's bring your ideas to life with a funky twist!
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link href="/Anirban-Resume.pdf" target={"_blank"}
                ...
                <Link href="mailto:anirban.chk1@gmail.com" target={"_blank"}
        ...
        <div className="absolute right-8 bottom-[12rem] inline-block w-24 md:hidden">
          <Image src={lightBulb} alt="Anirban" className='absolute w-full h-auto' />
        </div>
      </main>
    </>
  );
